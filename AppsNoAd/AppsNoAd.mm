...
@class KWKeyConfig; @class SWTipsView; @class SEUserVipInfoModel; @class QLVNUserCenterRecommendFeedViewModel; @class NewUserPageEntryCell; @class XCNativeAdData; @class SWCityFeedVC; @class NewUserPageController; @class KWMoreListItem; @class KWBgImageAndPendantTipView; @class ZYAdInfoFlow; @class KWAdvertisementForPlayerView; @class JXLiveRootSubCategoryMainFrameView; @class KWStarThemeDetailViewController; @class KHStartController; @class ZYNativeAdV2TableViewCell; @class SSReaderManager; @class PKBVVideoAlbumPlayerPresenter; @class PKBVStatisticsUserInfo; @class VungleSDK; @class SSDialogView; @class TVKWaterMarkModel; @class KWSplashPreLoaderHelper; @class MobileTracking; @class QNBUAPRCommonLandScapeViewModel; @class KWMusicFeeNeedPayTipsView; @class SSReadingAdSplashTask; @class QNBUAVIPActivityEntryViewModel; @class PNMemberBNewCell; @class KWMusicFeeUserManager; @class MainTabBarController; @class QNBUAFocusAdBlockViewModel; @class FLPatch; @class JXSystemInfo; @class ZYUIFeedNativeAdTableViewCell; @class QLONAInnerAdRecommendBannerCell; @class KWMusicPackageInfo; @class RootTabBarController; @class QLJCEONALeftImageRightTextAdPoster; @class QADFeedBaseViewModel; @class KWAudioADManager; @class QNBUAFocusVideoBlockViewModel; @class KWMusicCellViewModel; @class QLJCEONARecommendList; @class MVSingleAnimatedImageView; @class SSUserVipInfo; @class KWSplashAdInfoModel; @class PKBVUserVIPInfoModel; @class QLTeenGuardianPromptAssistant; @class PNLaunchADShowView; @class QLVMChannelViewController; @class LaunchViewController; @class KWSearchPlayBarCell; @class MVSplashScreenViewController; @class TADSplashBaseViewController; @class EMKLaunchADViewController; @class QLJCEONAAppList; @class OnlineAdItemInfo; @class KWSearchRecommandTipsView; @class SWCityPageVC; @class BBDigitalVerifyHelper; @class QADSplashWindow; @class SSAdTask; @class QNBQQPlayerPlugin; @class TADSplashManager; @class ADServer; @class JCommonServiceController; @class MediaItemInfo; @class QLJCEONAAdPoster; @class QNBUAPRPageCarouselCell; @class QLONAGalleryAdPosterView; @class QualityCell; @class ReportTaskService; @class PNConnectionViewController; @class KWMusicFeeTipsAlertView; @class TKApp; @class AppsViewCell; @class PKBVCommonRecommendViewNaviModel; @class ConnectADSmallCell; @class ZYSplashFeedAdView; @class KWMusicFeeFlagObject; @class QLJCEAdInsideVideoItem; @class QLJCEONAVideoAdPoster; @class DTSplashViewController; @class QADSplashSDK; @class QLVNOperationViewModel; 
...
#pragma mark - ========================> 初始化 <========================
static __attribute__((constructor)) void _logosLocalCtor_7a6c6882(int __unused argc, char __unused **argv, char __unused **envp) {
    ...
    if ([identify isEqualToString:Eleme]) {
        ...
        {Class _logos_class$BabyBus$BBDigitalVerifyHelper = objc_getClass("BBDigitalVerifyHelper"); Class _logos_metaclass$BabyBus$BBDigitalVerifyHelper = object_getClass(_logos_class$BabyBus$BBDigitalVerifyHelper); { MSHookMessageEx(_logos_metaclass$BabyBus$BBDigitalVerifyHelper, @selector(createWithTitle:warnTitle:complete:cancel:inputError:), (IMP)&_logos_meta_method$BabyBus$BBDigitalVerifyHelper$createWithTitle$warnTitle$complete$cancel$inputError$, (IMP*)&_logos_meta_orig$BabyBus$BBDigitalVerifyHelper$createWithTitle$warnTitle$complete$cancel$inputError$);}Class _logos_class$BabyBus$SEUserVipInfoModel = objc_getClass("SEUserVipInfoModel"); { MSHookMessageEx(_logos_class$BabyBus$SEUserVipInfoModel, @selector(vipType2), (IMP)&_logos_method$BabyBus$SEUserVipInfoModel$vipType2, (IMP*)&_logos_orig$BabyBus$SEUserVipInfoModel$vipType2);}{ MSHookMessageEx(_logos_class$BabyBus$SEUserVipInfoModel, @selector(vipExpiry), (IMP)&_logos_method$BabyBus$SEUserVipInfoModel$vipExpiry, (IMP*)&_logos_orig$BabyBus$SEUserVipInfoModel$vipExpiry);}{ MSHookMessageEx(_logos_class$BabyBus$SEUserVipInfoModel, @selector(vipEndTime), (IMP)&_logos_method$BabyBus$SEUserVipInfoModel$vipEndTime, (IMP*)&_logos_orig$BabyBus$SEUserVipInfoModel$vipEndTime);}{ MSHookMessageEx(_logos_class$BabyBus$SEUserVipInfoModel, @selector(vipStartTime), (IMP)&_logos_method$BabyBus$SEUserVipInfoModel$vipStartTime, (IMP*)&_logos_orig$BabyBus$SEUserVipInfoModel$vipStartTime);}Class _logos_class$BabyBus$RootTabBarController = objc_getClass("RootTabBarController"); { MSHookMessageEx(_logos_class$BabyBus$RootTabBarController, @selector(addChildViewController:), (IMP)&_logos_method$BabyBus$RootTabBarController$addChildViewController$, (IMP*)&_logos_orig$BabyBus$RootTabBarController$addChildViewController$);}}
    }
}
