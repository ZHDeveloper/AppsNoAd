...
@class QADSplashWindow; @class BLYDevice; @class QNBUAFocusAdBlockViewModel; @class KWAdvertisementForPlayerView; @class QLVMChannelViewController; @class KWMoreListItem; @class PKBVUserVIPInfoModel; @class HYPlayerViewControlView; @class KWMusicFeeFlagObject; @class KWMusicCellViewModel; @class QLJCEONALeftImageRightTextAdPoster; @class SSChapterEndCommentContainerView; @class QLJCEAdInsideVideoItem; @class TKApp; @class QNBUAVIPActivityEntryViewModel; @class AppsViewCell; @class KWSearchPlayBarCell; @class SWCityPageVC; @class KWSplashAdInfoModel; @class JXSystemInfo; @class HYWVideoPlayViewStatusModel; @class QualityCell; @class QNBQQPlayerPlugin; @class QLVNOperationViewModel; @class KHStartController; @class SSReadingAdSplashTask; @class QLJCEONAVideoAdPoster; @class KWSearchRecommandTipsView; @class KWMusicFeeNeedPayTipsView; @class QLONAInnerAdRecommendBannerCell; @class ADServer; @class PNConnectionViewController; @class EMKLaunchADViewController; @class KWMusicFeeTipsAlertView; @class UMConfigure; @class JCommonServiceController; @class MainTabBarController; @class PKBVVideoAlbumPlayerPresenter; @class TADSplashBaseViewController; @class KWStarThemeDetailViewController; @class ZYSplashFeedAdView; @class AppDelegate; @class KWBgImageAndPendantTipView; @class RootTabBarController; @class SSUserVipInfo; @class QLVNUserCenterRecommendFeedViewModel; @class VungleSDK; @class SWTipsView; @class SSReadingAdBaseViewController; @class PNMemberBNewCell; @class KWSplashPreLoaderHelper; @class ZYAdInfoFlow; @class HWQuestionsModel; @class MediaItemInfo; @class DTSplashViewController; @class PKBVStatisticsUserInfo; @class SSReaderManager; @class QLTeenGuardianPromptAssistant; @class QNBUAPRCommonLandScapeViewModel; @class SEUserModel; @class NewUserPageController; @class MobileTracking; @class QNBUAFocusVideoBlockViewModel; @class ZYUIFeedNativeAdTableViewCell; @class KWMusicPackageInfo; @class JXLiveRootSubCategoryMainFrameView; @class PKBVCommonRecommendViewNaviModel; @class FLPatch; @class QADSplashSDK; @class PNLaunchADShowView; @class NRPlayControlManager; @class CKVCManage; @class QLJCEONAAdPoster; @class SWCityFeedVC; @class NewUserPageEntryCell; @class ZYNativeAdV2TableViewCell; @class MVSplashScreenViewController; @class SSAdTask; @class LaunchViewController; @class XCNativeAdData; @class KWMusicFeeUserManager; @class KWKeyConfig; @class KWAudioADManager; @class SSDialogView; @class QLJCEONAAppList; @class MVSingleAnimatedImageView; @class ReportTaskService; @class ConnectADSmallCell; @class QLJCEONARecommendList; @class QLONAGalleryAdPosterView; @class GADMobileAds; @class TVKWaterMarkModel; @class QADFeedBaseViewModel; @class TADSplashManager; @class SEUserVipInfoModel; @class QNBUAPRPageCarouselCell; @class OnlineAdItemInfo; @class CYCacheManager; 
...
#line 50 "/Users/zhihuashen/Documents/Jailbreak/AppsNoAd/AppsNoAd/AppsNoAd.xm"
#pragma mark - ========================> 最右 <========================
...
static _Bool _logos_method$HuaYiExam$HYPlayerViewControlView$sliderMaxControl$CurrentSecondValue$(_LOGOS_SELF_TYPE_NORMAL HYPlayerViewControlView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, double arg1, double arg2) {
    return YES;
}
