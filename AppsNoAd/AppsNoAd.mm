...
@class QLJCEONAVideoAdPoster; @class ZYAdInfoFlow; @class NewUserPageEntryCell; @class KWAudioADManager; @class PKBVCommonRecommendViewNaviModel; @class KWSearchPlayBarCell; @class DTSplashViewController; @class MobileTracking; @class QLVNUserCenterRecommendFeedViewModel; @class PNMemberBNewCell; @class TADSplashBaseViewController; @class SSReaderManager; @class KWMusicPackageInfo; @class MVSplashScreenViewController; @class QLVMChannelViewController; @class KWMusicFeeNeedPayTipsView; @class KWSearchRecommandTipsView; @class EMKLaunchADViewController; @class QualityCell; @class PKBVVideoAlbumPlayerPresenter; @class QLTeenGuardianPromptAssistant; @class QLJCEONAAppList; @class MainTabBarController; @class KWStarThemeDetailViewController; @class QNBQQPlayerPlugin; @class SWTipsView; @class JXSystemInfo; @class QNBUAFocusAdBlockViewModel; @class QNBUAVIPActivityEntryViewModel; @class SSUserVipInfo; @class KHStartController; @class FLPatch; @class KWAdvertisementForPlayerView; @class ZYUIFeedNativeAdTableViewCell; @class SWCityFeedVC; @class ADServer; @class SWCityPageVC; @class NewUserPageController; @class ConnectADSmallCell; @class QLJCEONARecommendList; @class JXLiveRootSubCategoryMainFrameView; @class QLJCEAdInsideVideoItem; @class KWSplashPreLoaderHelper; @class KWMoreListItem; @class PKBVUserVIPInfoModel; @class QLONAInnerAdRecommendBannerCell; @class MediaItemInfo; @class TADSplashManager; @class KWMusicFeeUserManager; @class QLONAGalleryAdPosterView; @class TKApp; @class KWBgImageAndPendantTipView; @class QADFeedBaseViewModel; @class KuwoAnchorRadioContentController; @class KWMusicFeeFlagObject; @class ZYNativeAdV2TableViewCell; @class KWMusicFeeTipsAlertView; @class QNBUAPRCommonLandScapeViewModel; @class PKBVStatisticsUserInfo; @class QLJCEONALeftImageRightTextAdPoster; @class VungleSDK; @class QNBUAFocusVideoBlockViewModel; @class MVSingleAnimatedImageView; @class PNLaunchADShowView; @class KWSplashAdInfoModel; @class QLJCEONAAdPoster; @class LaunchViewController; @class QLVNOperationViewModel; @class SSDialogView; @class KWMusicCellViewModel; @class QADSplashSDK; @class ZYSplashFeedAdView; @class PNConnectionViewController; @class KWKeyConfig; @class QADSplashWindow; @class XCNativeAdData; @class AppsViewCell; @class OnlineAdItemInfo; @class QNBUAPRPageCarouselCell; @class SSAdTask; @class JCommonServiceController; @class TVKWaterMarkModel; @class SSReadingAdSplashTask; @class ReportTaskService; 
...
static void _logos_method$KWPlayer$KuwoAnchorRadioContentController$show_SoundAlbumSaleTipView$albumBought$(_LOGOS_SELF_TYPE_NORMAL KuwoAnchorRadioContentController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, void * arg2, bool arg3) {
    DLog(@"%@, %@", arg2);
    _logos_orig$KWPlayer$KuwoAnchorRadioContentController$show_SoundAlbumSaleTipView$albumBought$(self, _cmd, arg2, arg3);
}
...
static _Bool _logos_method$KWPlayer$KWKeyConfig$currentRegionCodeIsChineseMainland(_LOGOS_SELF_TYPE_NORMAL KWKeyConfig* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    return NO;
}
...
#pragma mark - ========================> 初始化 <========================
static __attribute__((constructor)) void _logosLocalCtor_52696bff(int __unused argc, char __unused **argv, char __unused **envp) {
