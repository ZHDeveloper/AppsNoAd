...
@class DTSplashViewController; @class QNBUAFocusVideoBlockViewModel; @class EMKLaunchADViewController; @class TADSplashBaseViewController; @class XCNativeAdData; @class QLJCEONALeftImageRightTextAdPoster; @class QNBUAFocusAdBlockViewModel; @class QNBQQPlayerPlugin; @class QLJCEONAAppList; @class PNLaunchADShowView; @class PNConnectionViewController; @class TKApp; @class PARSAdvertPopupView; @class QLJCEONARecommendList; @class QNBUAPRCommonLandScapeViewModel; @class ZYSplashFeedAdView; @class TVKWaterMarkModel; @class ConnectADSmallCell; @class QLVNOperationViewModel; @class MainTabBarController; @class QLVNUserCenterRecommendFeedViewModel; @class QLJCEONAAdPoster; @class QLJCEAdInsideVideoItem; @class QLONAInnerAdRecommendBannerCell; @class QLTeenGuardianPromptAssistant; @class FLPatch; @class KHStartController; @class QLONAGalleryAdPosterView; @class QNBUAPRPageCarouselCell; @class ZYUIFeedNativeAdTableViewCell; @class JKNFloatAdView; @class MVSingleAnimatedImageView; @class ReportTaskService; @class QLJCEONAVideoAdPoster; @class QADFeedBaseViewModel; @class ZYNativeAdV2TableViewCell; @class LaunchViewController; @class QADSplashSDK; @class ZYAdInfoFlow; @class QLVMChannelViewController; @class QNBUAVIPActivityEntryViewModel; @class MVSplashScreenViewController; @class JKNScreenADViewController; @class PNMemberBNewCell; @class QADSplashWindow; @class PARSHomePageADFloatView; 
...
#line 33 "/Users/zhihuashen/Documents/Jailbreak/AppsNoAd/AppsNoAd/AppsNoAd.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_3e386034(int __unused argc, char __unused **argv, char __unused **envp) {
