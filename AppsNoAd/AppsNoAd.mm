...
@class QLONAGalleryAdPosterView; @class LaunchViewController; @class ReportTaskService; @class SWCityFeedVC; @class ZYNativeAdV2TableViewCell; @class QLVNUserCenterRecommendFeedViewModel; @class QNBUAPRPageCarouselCell; @class VungleSDK; @class XCNativeAdData; @class ZYUIFeedNativeAdTableViewCell; @class PNConnectionViewController; @class SWTipsView; @class QLJCEONAAdPoster; @class QNBUAVIPActivityEntryViewModel; @class PARSHomePageADFloatView; @class QLONAInnerAdRecommendBannerCell; @class QNBUAFocusVideoBlockViewModel; @class QADFeedBaseViewModel; @class PNMemberBNewCell; @class DTSplashViewController; @class QLJCEONALeftImageRightTextAdPoster; @class MVSplashScreenViewController; @class ZYAdInfoFlow; @class TVKWaterMarkModel; @class EMKLaunchADViewController; @class PNLaunchADShowView; @class KHStartController; @class QADSplashSDK; @class QLVMChannelViewController; @class SWCityPageVC; @class MainTabBarController; @class JKNScreenADViewController; @class QADSplashWindow; @class MVSingleAnimatedImageView; @class ZYSplashFeedAdView; @class JKNFloatAdView; @class QLJCEONAAppList; @class TKApp; @class ConnectADSmallCell; @class TADSplashBaseViewController; @class QLVNOperationViewModel; @class AppsViewCell; @class QLJCEONARecommendList; @class FLPatch; @class ADServer; @class QNBUAFocusAdBlockViewModel; @class QLJCEONAVideoAdPoster; @class QNBQQPlayerPlugin; @class QLJCEAdInsideVideoItem; @class QNBUAPRCommonLandScapeViewModel; @class PARSAdvertPopupView; @class QLTeenGuardianPromptAssistant; 
...
#line 39 "/Users/zhihuashen/Documents/Jailbreak/AppsNoAd/AppsNoAd/AppsNoAd.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_1c20cbe8(int __unused argc, char __unused **argv, char __unused **envp) {
