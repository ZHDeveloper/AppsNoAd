...
@class QNBUAPRCommonLandScapeViewModel; @class MobileTracking; @class DTSplashViewController; @class QLVNOperationViewModel; @class KHStartController; @class MediaItemInfo; @class MVSingleAnimatedImageView; @class NewUserPageEntryCell; @class TKApp; @class KWBgImageAndPendantTipView; @class QNBQQPlayerPlugin; @class ConnectADSmallCell; @class SSDialogView; @class ZYSplashFeedAdView; @class MVSplashScreenViewController; @class KWSearchPlayBarCell; @class KWMusicFeeTipsAlertView; @class QLTeenGuardianPromptAssistant; @class PKBVUserVIPInfoModel; @class QLJCEONAAppList; @class KWMoreListItem; @class BBDigitalVerifyHelper; @class SSReaderManager; @class TADSplashManager; @class EMKLaunchADViewController; @class KWMusicFeeNeedPayTipsView; @class SEUserVipInfoModel; @class QNBUAPRPageCarouselCell; @class SWCityFeedVC; @class PNMemberBNewCell; @class QLONAGalleryAdPosterView; @class QLONAInnerAdRecommendBannerCell; @class QLJCEONALeftImageRightTextAdPoster; @class RootTabBarController; @class SWCityPageVC; @class FLPatch; @class JXLiveRootSubCategoryMainFrameView; @class SWTipsView; @class VungleSDK; @class LaunchViewController; @class KWAdvertisementForPlayerView; @class QLVMChannelViewController; @class ReportTaskService; @class PNConnectionViewController; @class KWMusicFeeFlagObject; @class KWAudioADManager; @class KWMusicFeeUserManager; @class SSReadingAdSplashTask; @class KWStarThemeDetailViewController; @class SEUserModel; @class KWMusicCellViewModel; @class PKBVStatisticsUserInfo; @class SSAdTask; @class ZYUIFeedNativeAdTableViewCell; @class TADSplashBaseViewController; @class ZYAdInfoFlow; @class QNBUAFocusAdBlockViewModel; @class JXSystemInfo; @class TVKWaterMarkModel; @class QLJCEONAVideoAdPoster; @class NewUserPageController; @class QADSplashSDK; @class QLJCEONARecommendList; @class ADServer; @class QualityCell; @class JCommonServiceController; @class SSUserVipInfo; @class KWSplashPreLoaderHelper; @class KWSplashAdInfoModel; @class KWMusicPackageInfo; @class QADFeedBaseViewModel; @class KWSearchRecommandTipsView; @class KWKeyConfig; @class PNLaunchADShowView; @class QNBUAFocusVideoBlockViewModel; @class QLJCEAdInsideVideoItem; @class QLJCEONAAdPoster; @class QADSplashWindow; @class QNBUAVIPActivityEntryViewModel; @class PKBVCommonRecommendViewNaviModel; @class QLVNUserCenterRecommendFeedViewModel; @class XCNativeAdData; @class ZYNativeAdV2TableViewCell; @class PKBVVideoAlbumPlayerPresenter; @class AppsViewCell; @class MainTabBarController; @class OnlineAdItemInfo; 
...
#line 42 "/Users/zhihuashen/Documents/Jailbreak/AppsNoAd/AppsNoAd/AppsNoAd.xm"
#pragma mark - ========================> 最右 <========================
...
#pragma mark - ========================> 初始化 <========================
static __attribute__((constructor)) void _logosLocalCtor_5c3ef080(int __unused argc, char __unused **argv, char __unused **envp) {
